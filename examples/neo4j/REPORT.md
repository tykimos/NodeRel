# GraphIndex 예제 적재 및 검증 결과

검증 시각(UTC): 2026-09-23T04:06:59.063Z

Movies와 Northwind를 실제 Neo4j에 불러온 뒤, SQLite 기반 GraphIndex에 변환·적재했습니다. 15개 질의를 양쪽에서 실행했으며, 반환 결과가 모두 일치했습니다. GraphIndex 독립 데모를 검증한 결과입니다.
...
| 예제 질의 | 결과 수 | GraphIndex | Neo4j | 일치 |
|---|---:|---:|---:|---|
...
- 관계를 따라가기, 공동 출연자, 여러 관계를 조합한 고객·상품 조회, 최단 연결 거리, 연결이 없는 항목 찾기를 GraphIndex로 수행할 수 있었습니다.
...
- 테스트용 Neo4j 서버는 종료했습니다. GraphIndex와 저장된 기준 결과는 그대로 재실행할 수 있습니다.
